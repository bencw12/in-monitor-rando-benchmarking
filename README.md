...
## /bin
Contains 3 Firecracker binaries: the stock Firecracker v0.26 without our patches [firecracker-nokaslr](https://github.com/bencw12/firecracker/tree/stock), Firecracker with just KASLR implemented [firecracker-kaslr](https://github.com/bencw12/firecracker/tree/kaslr), Firecracker with FG-KASLR implemented [firecracker-fgkaslr](https://github.com/bencw12/firecracker/tree/fgkaslr), and Firecracker with a patch to boot a bzImage [firecracker-bzImage](https://github.com/bencw12/firecracker.git). The `perf` binary is also included for use in tracing IO writes from the guest.
## /configs
